...
const ExternalLink = ({ href, children }) => (
  <a
    className='flex flex-row justify-center items-center mr-5 md:mr-7 last:mr-0 text-gray-500 hover:text-gray-600 transition'
    target='_blank'
...
const linkClasses =
  'text-sm md:text-base text-gray-600 dark:text-gray-600 mr-3 md:mr-10 last:mr-0'

const Footer = () => {
  return (
    <div className='border-t border-gray-300 dark:border-dark-secondary'>
      <footer className='w-full max-w-4xl mx-auto py-12'>
        <div className='socials flex flex-row justify-center items-center'>
          ...
          <ExternalLink href='https://www.linkedin.com/in/amirsolo/'>
