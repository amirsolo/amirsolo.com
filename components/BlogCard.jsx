...
const BlogCard = ({ title, summary, slug, publishedAt, home }) => {
  return (
    <Link href={`/blog/${slug}`}>
      <a className='inline-block w-full py-2 px-6 my-5 md:my-4 border-l-2  border-primary-color hover:border-gray-800 dark:hover:border-blue-200 dark:bg-dark-primary'>
