  ...
  return (
    <Container title='404 (Not Found) – Amir Solo'>
      <div className='flex flex-col justify-center items-start text-center'>
        <div className='404-icon w-full flex flex-row justify-center text-center'>
          <svg
            version='1.1'
            id='Capa_1'
            ...
            fill='currentColor'
            className='w-32 sm:w-44 text-gray-700 dark:text-gray-200'
          >
            <g>
              <g>
                <path
                  d='M140.61,273.063h-5.956v-22.69c0-11.623-10.593-19.433-26.358-19.433s-26.357,7.81-26.357,19.433v22.69H65.571
            ...
            <g>
              <g>
                <path
                  d='M492.566,273.063h-5.956v-22.69c0-11.623-10.593-19.433-26.358-19.433s-26.357,7.81-26.357,19.433v22.69h-16.368
            ...
            <g>
              <g>
                <path
                  d='M330.892,206.939c-2.512-3.363-7.279-4.051-10.642-1.536c-3.362,2.515-4.05,7.281-1.535,10.643
            ...
            <g>
              <g>
                <path
                  d='M296.624,292.726l-29.863-29.863L296.624,233c2.968-2.969,2.968-7.783-0.002-10.753c-2.971-2.97-7.784-2.97-10.754,0
        ...
        <h1 className='w-full text-center text-3xl sm:text-5xl font-bold -mt-4 smb-8 text-gray-700 dark:text-gray-200'>
          Not Found
        </h1>
        ...
        <Link href='/'>
          <a className='w-40 p-1 sm:px-4 sm:py-3 mt-12 font-semibold mx-auto text-center rounded border text-gray-800 dark:text-gray-300 border-gray-300 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-dark-secondary'>
            Back Home
          </a>
        </Link>
      </div>
